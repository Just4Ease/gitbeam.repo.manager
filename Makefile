...
proto:
	...
	mkdir -p ${PROTO_DST_DIR}/repos && protoc -I=${PROTO_SRC_DIR}/repos --go_out=plugins=grpc:${PROTO_DST_DIR}/repos ${PROTO_SRC_DIR}/repos/repos.proto
	make alignment
...
lint:
	@hash golangci-lint > /dev/null 2>&1; if [ $$? -ne 0 ]; then \
		...
		curl -sfL https://install.goreleaser.com/github.com/golangci/golangci-lint.sh | sh -s -- -b $(GOPATH)/bin v1.61.0; \
	fi
